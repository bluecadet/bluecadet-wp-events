...
class MetaKeys {
  ...
  private function generate_keys() {
    $this->keys = [
      ...
      'freq_concurrent_offset' => Settings::$events_meta_ns . 'frequency_concurrent_offset',
      'freq_concurrent_count' => Settings::$events_meta_ns . 'frequency_concurrent_count',
  ...
  public static function get_event_save_keys() : array {
    ...
    return [
      ...
      $instance->keys['freq_concurrent_offset'] => 'integer',
      $instance->keys['freq_concurrent_count'] => 'integer',
